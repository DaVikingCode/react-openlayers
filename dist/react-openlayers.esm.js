...
import { Map as Map$1, View as View$1 } from 'ol';
...
var MapContext = /*#__PURE__*/React.createContext(undefined);
...
var Map = function Map(_ref) {
  ...
  useEffect(function () {
    ...
    var mapObject = new Map$1(options);
...
var MapControls = function MapControls(_ref) {
  ...
  return overlay ? ReactDOM.createPortal(React.createElement("div", {
...
var styles = (_styles = {}, _styles[ControlPosition.BottomRight] = /*#__PURE__*/_extends({}, commonStyles, {
  ...
  flexDirection: "column",
  alignItems: "flex-end"
}), _styles[ControlPosition.BottomRightMobile] = /*#__PURE__*/_extends({}, commonStyles, {
  gridArea: "bottom-right",
  marginLeft: "auto",
  flexDirection: "column",
  alignItems: "flex-end",
...
var FullScreenControl = function FullScreenControl(_ref) {
  ...
  return CustomControl ? React.createElement(CustomControl, {
...
var Modify = function Modify(_ref) {
  ...
  useEffect(function () {
    ...
    var _modify = new Modify$1(options);
